#!/usr/bin/env python3
"""Live-validate three archived BLS Consumer Price Index releases."""
...
from finreplay.adapters import AdapterBatch, BLSCPIArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/bls-cpi"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/bls-cpi/live"),
    )
