#!/usr/bin/env python3
"""Run the relevant engines and build a deterministic macro revision ReplayPack."""
...
from finreplay.scenarios import build_macro_revision_replay_spec, load_macro_revision_input_lock
...
def main() -> None:
    ...
    spec = build_macro_revision_replay_spec(lock, code_commit=code_commit)
    studio = ReplayStudio()
