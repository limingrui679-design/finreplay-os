#!/usr/bin/env python3
"""Build the deterministic BTFP facility-growth ReplayPack."""
...
from finreplay.scenarios import build_facility_growth_replay_spec, load_facility_growth_input_lock
...
def main() -> None:
    ...
    spec = build_facility_growth_replay_spec(lock, code_commit=code_commit)
    studio = ReplayStudio()
