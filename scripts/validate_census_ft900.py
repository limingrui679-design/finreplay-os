#!/usr/bin/env python3
"""Live-validate three paired Census/BEA FT-900 release snapshots."""
...
from finreplay.adapters import AdapterBatch, CensusBEAFT900ArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/census-ft900"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/census-ft900/live"),
    )
