#!/usr/bin/env python3
"""Live-validate three archived FHFA House Price Index reports."""
...
from finreplay.adapters import AdapterBatch, FHFAHPIArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/fhfa-hpi"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/fhfa-hpi/live"),
    )
