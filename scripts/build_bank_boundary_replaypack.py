#!/usr/bin/env python3
"""Run all seven engines and build a deterministic bank boundary ReplayPack."""
...
from finreplay.scenarios import build_bank_boundary_replay_spec, load_bank_boundary_input_lock
...
def main() -> None:
    ...
    spec = build_bank_boundary_replay_spec(lock, code_commit=code_commit)
    studio = ReplayStudio()
