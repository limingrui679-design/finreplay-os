#!/usr/bin/env python3
"""Live-validate three paired archived EIA WPSR Table 4 releases."""
...
from finreplay.adapters import AdapterBatch, EIAWPSRCommercialCrudeStocksAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/eia-wpsr"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/eia-wpsr/live"),
    )
