#!/usr/bin/env python3
"""Live-validate three paired archived BLS Producer Price Index releases."""
...
from finreplay.adapters import AdapterBatch, BLSPPIArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/bls-ppi"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/bls-ppi/live"),
    )
