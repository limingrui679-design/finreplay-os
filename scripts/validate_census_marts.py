#!/usr/bin/env python3
"""Live-validate three paired Census MARTS release snapshots."""
...
from finreplay.adapters import AdapterBatch, CensusMARTSArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/census-marts"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/census-marts/live"),
    )
