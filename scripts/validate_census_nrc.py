#!/usr/bin/env python3
"""Live-validate three Census/HUD NRC archived release snapshots."""
...
from finreplay.adapters import AdapterBatch, CensusHUDNRCArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/census-nrc"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/census-nrc/live"),
    )
