#!/usr/bin/env python3
"""Live-validate the schedule-anchored CFTC TFF UST 2-year evidence chain."""
...
from finreplay.adapters import CFTCTFFScheduledReleaseAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/cftc-tff-schedule/live"),
    )
...
def main() -> None:
    ...
    with SafeHttpClient(
        ...
        batch = CFTCTFFScheduledReleaseAdapter(http).fetch()
