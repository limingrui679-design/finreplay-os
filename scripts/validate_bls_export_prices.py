#!/usr/bin/env python3
"""Live-validate three paired archived BLS all-export price releases."""
...
from finreplay.adapters import AdapterBatch, BLSExportPriceArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/bls-export-prices"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/bls-export-prices/live"),
    )
