#!/usr/bin/env python3
"""Live-validate three archived Census M3 advance durable-goods reports."""
...
from finreplay.adapters import AdapterBatch, CensusDurableGoodsArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/census-m3-durable-goods"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/census-m3-durable-goods/live"),
    )
