#!/usr/bin/env python3
"""Live-validate three paired H.4.1 central-bank-liquidity-swap releases."""
...
from finreplay.adapters import AdapterBatch, FederalReserveH41LiquiditySwapsAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/fed-h41-liquidity-swaps"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/fed-h41-liquidity-swaps/live"),
    )
