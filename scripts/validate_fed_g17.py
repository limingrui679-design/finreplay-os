#!/usr/bin/env python3
"""Live-validate three paired Federal Reserve G.17 releases."""
...
from finreplay.adapters import AdapterBatch, FederalReserveG17ArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/fed-g17"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/fed-g17/live"),
    )
