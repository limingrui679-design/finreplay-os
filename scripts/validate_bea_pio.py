#!/usr/bin/env python3
"""Live-validate three paired BEA Personal Income and Outlays releases."""
...
from finreplay.adapters import AdapterBatch, BEAPersonalIncomeOutlaysArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/bea-pio"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/bea-pio/live"),
    )
