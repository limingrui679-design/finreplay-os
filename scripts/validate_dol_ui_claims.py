#!/usr/bin/env python3
"""Live-validate three archived DOL weekly initial-claims releases."""
...
from finreplay.adapters import AdapterBatch, DOLWeeklyClaimsArchiveAdapter
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--raw-store",
        type=Path,
        default=Path("data/raw/supporting/dol-ui-claims"),
    )
    parser.add_argument(
        "--receipt-directory",
        type=Path,
        default=Path("verification/supporting/dol-ui-claims/live"),
    )
