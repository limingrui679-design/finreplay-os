...
`verification/evidence/internal-quality-gates.json` receipt binds a clean `ff0b8eeddb33` subject
...
non-disclosing local scanner checked 1,437 tracked text files and 14,317,223 UTF-8 bytes with zero
