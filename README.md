...
[![Release: v0.2.0a1](https://img.shields.io/badge/release-v0.2.0a1-6f42c1.svg)](https://github.com/limingrui679-design/finreplay-os/releases/tag/v0.2.0a1)
...
The [v0.2.0a1 prerelease](https://github.com/limingrui679-design/finreplay-os/releases/tag/v0.2.0a1)
also provides the verified wheel, source distribution, and `SHA256SUMS` generated by the release
workflow.
