...
- Counted Census/HUD new-home-sales, EIA WNGSR working-gas, BLS PPI
  ...
  boundary replay, bringing the eight-gate scenario catalog to 29 of 30 planned
  scenarios.
...
- README scenario totals and all 29 evidence summaries now match the verified
  scenario catalog.
